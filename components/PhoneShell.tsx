...
export function PhoneShell(props: { children: React.ReactNode }) {
  return (
    <div className="phone-root flex min-h-dvh w-full flex-col bg-bmm-sky md:min-h-dvh md:items-center md:justify-center md:bg-gradient-to-b md:from-zinc-700 md:to-zinc-900 md:py-6">
      <div className="relative flex min-h-dvh w-full flex-col bg-bmm-sky md:mx-auto md:min-h-0 md:h-[min(852px,calc(100dvh-48px))] md:max-h-[852px] md:w-[min(428px,calc(100vw-40px))] md:rounded-[2.85rem] md:border-[14px] md:border-zinc-900 md:bg-zinc-900 md:shadow-[0_28px_80px_rgba(0,0,0,0.55)] md:ring-1 md:ring-white/10">
